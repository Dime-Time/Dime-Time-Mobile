...
export class MemStorage implements IStorage {
  ...
  private initializeDemoData() {
    ...
    // Create demo crypto purchases with much higher amounts (~$12,000 total)
